    ...
    <body>
        <div style="position:absolute;">
            <div id="body">
                ...
                <p>We hope that we have given you the service you needed. You can still activate your account if you wish to, just let us know. If you want to permanently delete your account, contact our administrator. </p>
                <p>Thank you!</p>
                <br>
                <hr/>
